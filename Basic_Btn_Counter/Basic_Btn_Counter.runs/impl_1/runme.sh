...
HD_PWD='C:/Users/adityasehgal/Documents/GitHub/Verilog_Projects/Basic_Btn_Counter/Basic_Btn_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log au_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source au_top.tcl -notrace
