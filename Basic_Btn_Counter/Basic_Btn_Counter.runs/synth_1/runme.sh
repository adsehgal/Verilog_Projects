...
HD_PWD='C:/Users/adityasehgal/Documents/GitHub/Verilog_Projects/Basic_Btn_Counter/Basic_Btn_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log au_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source au_top.tcl
